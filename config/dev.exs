...
config :live_poll, LivePollWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Ub2QNCrgjoAHZqjahc9/UHBUqR4hdLp89aaYl5bU9HXVjUDJ/C/SXQ9YnoKMd1Zn",
  watchers: [
...
config :live_poll, LivePollWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/live_poll_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :live_poll, dev_routes: true
